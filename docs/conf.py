...
"""
ibl-edx-greeting documentation build configuration file.
...
project = 'ibl-edx-greeting'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'ibl-edx-greeting'
...
#
# html_title = 'ibl-edx-greeting v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'REST API endpoint greeting',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'ibl_edx_greeting'),
                os.path.join(root_path, 'ibl_edx_greeting/migrations')])
